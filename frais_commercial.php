            ...
            <table class="table table-striped table-hover" id="table_id">
              ...
              <tbody>
                ...
                foreach ($data as $row) {
                    ...
                    <td>".$row['nom_type']."</td>
                    <td>".$row['nom_etat']."</td>
                    <td><a class='yellow' href='modification_commercial.php?idfrais=".$row['id_frais']."'>Modifier</a></td>
                    <td><a class='red' href='suppressionfrais_commercial.php?idfrais=".$row['id_frais']."'>Supprimer</a></td>
                    </tr>";  
                  }
