          ...
          <div class="col-md-12">
            <table class="table table-striped table-hover" id="table_id">
              ...
              <tbody>
                ...
                $data = $db->query("SELECT * FROM frais INNER JOIN type ON type.id_type = frais.id_type INNER JOIN etat ON etat.id_etat = frais.id_etat WHERE frais.id_etat = 1")->fetchAll() ;
                ...
                foreach ($data as $row) {
                  ...
                  <td>".$row['nom_type']."</td>
                  <td>".$row['nom_etat']."</td>
                  <td><a class='green' href='validerfrais.php?idfrais=".$row['id_frais']."'> Valider</a></td>
                  <td><a class='black' href='rejeterfrais.php?idfrais=".$row['id_frais']."'> rejeter</a></td>
                  </tr>";  
                }
            ...
            <table class="table table-striped table-hover " id="table" >
              ...
              <tbody>
                ...
                foreach ($data as $row) {
                  ...
                  <td>".$row['nom_etat']."</td>
                  <td><a class='black' href='rejeterfrais.php?idfrais=".$row['id_frais']."'> rejeter</a></td>
                  <td><a class='red' href='suppressionfrais.php?idfrais=".$row['id_frais']."'>Supprimer</a></td>
                  </tr>";  
                }
            ...
            <table class="table table-striped table-hover " id="table2" >
              ...
              <tbody>
                ...
                foreach ($data as $row) {
                  ...
                  <td>".$row['nom_type']."</td>
                  <td>".$row['nom_etat']."</td>
                  <td><a class='green' href='validerfrais.php?idfrais=".$row['id_frais']."'><i class='bx bx-trash '></i> Valider</a></td>
                  <td><a class='red' href='suppressionfrais.php?idfrais=".$row['id_frais']."'>Supprimer</a></td>
                  </tr>";  
                }
