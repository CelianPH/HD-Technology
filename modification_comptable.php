    ...
    <div class="container">
      <div class="row card2">
        <div class="container"> 
          ...
          <a href="mesfraisC.php" class="btn btn-outline-primary btn_utilisateur"><- Frais</a>
            <form method="post" action="modifier_comptable.php">
              <center>
              ...
              <div class="col-md-3 case3">
                ...
                <input type="text" name="nom2" id="nom2" class="form-control" value="<?php echo $contact['nom2'];?> "readonly>
              </div>
              <div class="col-md-3 case2">
                <br><label for="prenom2" class="form-label">Prenom :</label>
                <input type="text" name="prenom2" id="prenom2" class="form-control"value="<?php echo $contact['prenom2'];?> " readonly>
              </div>
              ...
              <div class="col-md-3 case6">
                <br><br><select id="num_type" class="form-select" aria-label="Default select example" name="type" value="<?php echo $contact['type'];?> ">
