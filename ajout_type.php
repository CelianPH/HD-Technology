...
<!doctype html>
  ...
  <body>
    ...
    <div class="container">
      <div class="row card2">
        <h3>Ajouter un type de frais</h3>
        <form method="post" action="ajout_type.php">
          <div class="col-md-3 case9">
              <br><label for="nom" class="form-label case">Nom type :</label>
              <input type="text" name="nom_type" id="nom_type" class="form-control" required>
            </div> 
            <div class="col-mb-5 position1">
              <br><input type="submit" name="ajout3" id="ajout3" value="Ajouter" class="btn btn-primary ajout">
            </div>
            <?php
          if (isset($_POST['ajout3'])){
            ...
            $stmt = $db->prepare("INSERT INTO type (nom_type) VALUES (:nom_type)");
            ...
            <table class="table table-striped table-hover" id="table_id">
              ...
              <tbody>
                ...
                foreach ($data as $row) {
                  ...
                  <td>".$row['id_type']."</td>
                  <td>".$row['nom_type']."</td>
                  <td><a class='red' href='suppression_type.php?id_type=".$row['id_type']."'>Supprimer</a></td>
                  </tr>";  
                }
