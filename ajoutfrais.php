      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="ajout_type.php">Ajout Rôle</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
      <div class="row card2">
        <div class="container"> 
          ...
          <a href="mesfrais.php" class="btn btn-outline-primary btn_utilisateur"><- Frais</a>
