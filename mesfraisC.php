...
<div class="container">
      <div class="row card1">
        <div class="container">
          ...
          <form method="post" action="ajoutfrais_comptable.php"> 
            <div class="col-mb-3">
            ...
            <table class="table table-striped table-hover " id="table_id" >
              ...
              <tbody>
                ...
                foreach ($data as $row) {
                  ...
                  <td>".$row['nom_type']."</td>
                  <td>".$row['nom_etat']."</td>
                  <td><a class='yellow' href='modification_comptable.php?idfrais=".$row['id_frais']."'>Modifier</a></td>
                  <td><a class='red' href='suppressionmesfrais_comptable.php?idfrais=".$row['id_frais']."'>Supprimer</a></td>
                  </tr>";  
                }
